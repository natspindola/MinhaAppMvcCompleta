...
CREATE TABLE [Produtos] (
    ...
    CONSTRAINT [FK_Produtos_Enderecos_EnderecoId] FOREIGN KEY ([EnderecoId]) REFERENCES [Enderecos] ([Id]) ON DELETE NO ACTION,
...
CREATE INDEX [IX_Produtos_EnderecoId] ON [Produtos] ([EnderecoId]);
...
VALUES (N'20220616182727_Initial', N'2.2.6-servicing-10079');
